...
export default function SewingTable() {
  ...
  return (
    <group position={position} scale={scale}>
      ...
      <RoundedBox castShadow args={[4.45, 0.34, 1.18]} radius={0.1} smoothness={5} position={[0, 1.9, -0.05]}>
        <meshStandardMaterial {...clayMaterialProps.secondary} />
      </RoundedBox>

      <TableLeg position={[-2.08, 1.02, 0.54]} rotationZ={0.055} />
      <TableLeg position={[2.08, 1.02, 0.54]} rotationZ={-0.055} />
      <TableLeg position={[-2.08, 1.02, -0.54]} rotationZ={0.035} />
      <TableLeg position={[2.08, 1.02, -0.54]} rotationZ={-0.035} />
    </group>
  )
}
